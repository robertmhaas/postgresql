				   ...
				   ExplainState *es)
{
	 ...
	 * CurrentMemoryContext set to some shorter-lived context. So, record
	 * the context that should be used for allocations that need to live
	 * as long as the pgpa_planner_state itself.
	 */
	if (needs_pps)
	{
